(ns io.github.getcolors.k8s.ssh-config
...
;; migration is in flight; see `owned-markers`.
(defn superseded-begin-marker [alias] (str "# BEGIN k8s " alias " ANSIBLE MANAGED BLOCK"))
(defn superseded-end-marker [alias] (str "# END k8s " alias " ANSIBLE MANAGED BLOCK"))
